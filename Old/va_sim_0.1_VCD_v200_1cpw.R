...
r_period = 300
period = 300
available_vaccines = 200 #500 for 10000 people
iters = 100
...
write_csv(sim_result_total_pv, "sim_result_post_vac_VCD_v200_1cpw_0205.csv")
write_csv(sim_result_sym_pv, "sim_result_post_vac_sym_only_VCD_v200_1cpw_0205.csv")
