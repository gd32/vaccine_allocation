...
r_period = 300
period = 300
available_vaccines = 100 #500 for 10000 people - 200? 500?
iters = 100
...
write_csv(sim_result_total_pv, "sim_result_post_vac_VHC_1cperweek_block1_v100_0205.csv")
write_csv(sim_result_sym_pv, "sim_result_post_vac_VHC_1cperweek_block1_v100_sym_only_0205.csv")
