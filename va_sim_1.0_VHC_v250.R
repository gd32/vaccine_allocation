...
r_period = 300
period = 300
available_vaccines = 250 #500 for 10000 people - 200? 500?
iters = 100
...
write_csv(sim_result_total_pv, "sim_result_VHC_v250_0209.csv")
write_csv(sim_result_sym_pv, "sim_result_sym_VHC_v250_0209.csv")
